...
export function InputControl(props: InputControlProps) {
  return (
    <input
      className="tex-zinc-900 w-full flex-1 border-0 bg-transparent p-0 text-zinc-500 placeholder-zinc-500 outline-none dark:text-zinc-100 dark:placeholder:text-zinc-400"
      {...props}
    />
  )
}
