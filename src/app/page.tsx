        ...
        >
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <div className="flex items-start gap-5">
              ...
              <label
                htmlFor="photo"
                className="group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-200 px-6 py-4 text-center text-sm text-zinc-500 shadow-sm hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500"
              >
